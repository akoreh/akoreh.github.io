import{a as mt}from"./chunk-K66EXUFO.js";import{l as pt}from"./chunk-WSO2QVS5.js";import{a as dt,d as ht,i as ft,m as yt}from"./chunk-4Z7WS5KL.js";import{b as ut,c as lt}from"./chunk-5RVANUM6.js";import{h as ct,i as j}from"./chunk-NJPGD756.js";import{$b as at,Cb as F,Ib as X,Jb as Z,La as p,Lb as tt,Ob as C,Pb as et,Qb as N,Rb as nt,Sb as ot,Tb as it,Ub as rt,Zb as st,_a as k,ba as E,ga as d,gc as L,ha as h,hc as Y,lb as U,mb as K,pb as B,qb as G,rb as Q,sa as g,sb as D,tb as x,ub as H,vb as O,wb as P,xb as J,zb as q}from"./chunk-G7STBN2K.js";var jt=Math.pow(10,8)*24*60*60*1e3,Qt=-jt;var gt=864e5,Dt=6e4,xt=36e5;var $t=3600;var St=$t*24,Jt=St*7,Rt=St*365.2425,Vt=Rt/12,qt=Vt*3,$=Symbol.for("constructDateFrom");function l(o,i){return typeof o=="function"?o(i):o&&typeof o=="object"&&$ in o?o[$](i):o instanceof Date?new o.constructor(i):new Date(i)}function c(o,i){return l(i||o,o)}function Tt(o,i,t){let e=c(o,t?.in);return isNaN(i)?l(t?.in||o,NaN):(i&&e.setDate(e.getDate()+i),e)}function _t(o,i,t){let e=c(o,t?.in);if(isNaN(i))return l(t?.in||o,NaN);if(!i)return e;let n=e.getDate(),r=l(t?.in||o,e.getTime());r.setMonth(e.getMonth()+i+1,0);let s=r.getDate();return n>=s?r:(e.setFullYear(r.getFullYear(),r.getMonth(),n),e)}function S(o,i,t){let{years:e=0,months:n=0,weeks:r=0,days:s=0,hours:a=0,minutes:u=0,seconds:f=0}=i,_=c(o,t?.in),M=n||e?_t(_,n+e*12):_,w=s||r?Tt(M,s+r*7):M,I=u+a*60,b=(f+I*60)*1e3;return l(t?.in||o,+w+b)}function R(o){let i=c(o),t=new Date(Date.UTC(i.getFullYear(),i.getMonth(),i.getDate(),i.getHours(),i.getMinutes(),i.getSeconds(),i.getMilliseconds()));return t.setUTCFullYear(i.getFullYear()),+o-+t}function m(o,...i){let t=l.bind(null,o||i.find(e=>typeof e=="object"));return i.map(t)}function V(o,i){let t=c(o,i?.in);return t.setHours(0,0,0,0),t}function Mt(o,i,t){let[e,n]=m(t?.in,o,i),r=V(e),s=V(n),a=+r-R(r),u=+s-R(s);return Math.round((a-u)/gt)}function y(o,i){let t=+c(o)-+c(i);return t<0?-1:t>0?1:t}function Ct(o,i,t){let[e,n]=m(t?.in,o,i),r=e.getFullYear()-n.getFullYear(),s=e.getMonth()-n.getMonth();return r*12+s}function wt(o,i,t){let[e,n]=m(t?.in,o,i);return e.getFullYear()-n.getFullYear()}function bt(o,i,t){let[e,n]=m(t?.in,o,i),r=It(e,n),s=Math.abs(Mt(e,n));e.setDate(e.getDate()-r*s);let a=+(It(e,n)===-r),u=r*(s-a);return u===0?0:u}function It(o,i){let t=o.getFullYear()-i.getFullYear()||o.getMonth()-i.getMonth()||o.getDate()-i.getDate()||o.getHours()-i.getHours()||o.getMinutes()-i.getMinutes()||o.getSeconds()-i.getSeconds()||o.getMilliseconds()-i.getMilliseconds();return t<0?-1:t>0?1:t}function T(o){return i=>{let e=(o?Math[o]:Math.trunc)(i);return e===0?0:e}}function kt(o,i,t){let[e,n]=m(t?.in,o,i),r=(+e-+n)/xt;return T(t?.roundingMethod)(r)}function v(o,i){return+c(o)-+c(i)}function Ot(o,i,t){let e=v(o,i)/Dt;return T(t?.roundingMethod)(e)}function vt(o,i){let t=c(o,i?.in);return t.setHours(23,59,59,999),t}function At(o,i){let t=c(o,i?.in),e=t.getMonth();return t.setFullYear(t.getFullYear(),e+1,0),t.setHours(23,59,59,999),t}function Et(o,i){let t=c(o,i?.in);return+vt(t,i)==+At(t,i)}function Ht(o,i,t){let[e,n,r]=m(t?.in,o,o,i),s=y(n,r),a=Math.abs(Ct(n,r));if(a<1)return 0;n.getMonth()===1&&n.getDate()>27&&n.setDate(30),n.setMonth(n.getMonth()-s*a);let u=y(n,r)===-s;Et(e)&&a===1&&y(e,r)===1&&(u=!1);let f=s*(a-+u);return f===0?0:f}function Pt(o,i,t){let e=v(o,i)/1e3;return T(t?.roundingMethod)(e)}function Ft(o,i,t){let[e,n]=m(t?.in,o,i),r=y(e,n),s=Math.abs(wt(e,n));e.setFullYear(1584),n.setFullYear(1584);let a=y(e,n)===-r,u=r*(s-+a);return u===0?0:u}function Nt(o,i){let[t,e]=m(o,i.start,i.end);return{start:t,end:e}}function Lt(o,i){let{start:t,end:e}=Nt(i?.in,o),n={},r=Ft(e,t);r&&(n.years=r);let s=S(t,{years:n.years}),a=Ht(e,s);a&&(n.months=a);let u=S(s,{months:n.months}),f=bt(e,u);f&&(n.days=f);let _=S(u,{days:n.days}),M=kt(e,_);M&&(n.hours=M);let w=S(_,{hours:n.hours}),I=Ot(e,w);I&&(n.minutes=I);let z=S(w,{minutes:n.minutes}),b=Pt(e,z);return b&&(n.seconds=b),n}var Yt=(()=>{class o{path=L.required();date=L.required();static \u0275fac=function(e){return new(e||o)};static \u0275cmp=k({type:o,selectors:[["ps-terminal-app-status-bar"]],inputs:{path:[1,"path"],date:[1,"date"]},decls:9,vars:5,consts:[[1,"ps-terminal-app-status-bar","relative"],[1,"line"],["data-testid","bar",1,"flex","justify-between","pr-2"],[1,"flex","flex-col"],["data-testid","path"],["data-testid","date"]],template:function(e,n){e&1&&(O(0,"div",0),J(1,"div",1),O(2,"div",2)(3,"div",3)(4,"span",4),C(5),P()(),O(6,"span",5),C(7),st(8,"date"),P()()()),e&2&&(p(5),N(" ",n.path()," "),p(2),N(" at ",at(8,2,n.date(),"HH:mm:ss")," "))},dependencies:[ct],encapsulation:2,changeDetection:0})}return o})();var W=[{command:"clear",shortHelpDescription:"Clears the entire console"},{command:"auth",shortHelpDescription:"Authentication related commands",commandArguments:[{name:"status"},{name:"login"},{name:"logout"}]},{command:"ls",shortHelpDescription:"Lists the contents of the current directory"},{command:"hello",shortHelpDescription:"Say hello"},{command:"whoami",shortHelpDescription:"Prints the name of the current user"},{command:"uptime",shortHelpDescription:"Prints the time since the system has been live"},{command:"cowsay",shortHelpDescription:"Make the cow say something"},{command:"pwd",shortHelpDescription:"Print current working directory"},{command:"cd",shortHelpDescription:"Change directory"},{command:"cat",shortHelpDescription:"Display file contents"},{command:"echo",shortHelpDescription:"Display a line of text"},{command:"date",shortHelpDescription:"Display current date and time"},{command:"env",shortHelpDescription:"Display environment information"},{command:"history",shortHelpDescription:"Display command history"},{command:"about",shortHelpDescription:"About this portfolio"},{command:"skills",shortHelpDescription:"Display technical skills"},{command:"projects",shortHelpDescription:"List notable projects"},{command:"contact",shortHelpDescription:"Get contact information"},{command:"help",shortHelpDescription:"Print all available commands"}];var A=class{path;id;createdAt;get stdOut(){return this._stdOut}constructor(i){this.path=i,this.id=mt(),this.createdAt=new Date().toISOString()}_stdOut="";pushToStdOut(i){this._stdOut+=`${i}`}};var zt=["input"],Ut=["container"],Kt=(o,i)=>i.id;function Bt(o,i){o&1&&(D(0,"pre",9),C(1),x()),o&2&&(p(),et(i))}function Gt(o,i){if(o&1&&(D(0,"div"),H(1,"ps-terminal-app-status-bar",8),U(2,Bt,2,1,"pre",9),x()),o&2){let t,e=i.$implicit;p(),Q("path",e.path)("date",e.createdAt),p(),K((t=e.stdOut)?2:-1,t)}}var Wn=(()=>{class o{currentPath=g("~/Desktop");terminalEvents=g([]);command=g("");cursorPos=g(0);isLoginFlow=g(!1);_input=Y("input");_container=Y("container");availableCommands=W.map(({command:t})=>t);commandHistory=[];historyIndex=-1;tempCommand="";get input(){return this._input()?.nativeElement}decimalPipe=E(j);authStore=E(pt);ngOnInit(){this.pushEmptyExecution()}ngAfterViewInit(){this.onFocusInput()}async onExecCommand(){let t=this.command().trim();if(!t){this.pushEmptyExecution();return}t&&t!==this.commandHistory[this.commandHistory.length-1]&&this.commandHistory.push(t),this.historyIndex=-1,this.tempCommand="";let{baseCommand:e,args:n}=this.parseCommand(t);this.printToStdOut(`$ ${t}`);let r=lt(W,({command:s})=>s===e);if(!r)this.printToStdOut(`
...
Feel free to reach out for opportunities or collaborations!`)}parseCommand=t=>{let n=t.split(" ");return{baseCommand:n[0].trim().toLowerCase(),args:[...n.slice(1)]}};static \u0275fac=function(e){return new(e||o)};static \u0275cmp=k({type:o,selectors:[["ps-terminal-app"]],viewQuery:function(e,n){e&1&&X(n._input,zt,5)(n._container,Ut,5),e&2&&Z(2)},features:[rt([j])],decls:10,vars:3,consts:[["container",""],["input",""],[1,"ps-terminal-app","flex","h-full","w-full","flex-1","flex-col","overflow-y-auto","scroll-smooth","p-2",3,"click"],[1,"flex","flex-col","gap-2"],["cdkTrapFocus","",1,"mt-2"],[1,"relative","w-full"],["autocomplete","off","autocorrect","off","autocapitalize","off","spellcheck","false","type","text",1,"w-full","cursor-default","bg-transparent","font-mono","text-sm","caret-transparent","outline-none",3,"ngModelChange","input","click","keyup","keydown","keydown.enter","ngModel"],[1,"animate-blink","pointer-events-none","absolute","top-0","left-0","h-[1.4em]","w-[0.6ch]","bg-black"],[1,"pointer-events-none","select-none",3,"path","date"],[1,"font-mono","text-sm","leading-relaxed","break-words","whitespace-pre-wrap"]],template:function(e,n){if(e&1){let r=q();D(0,"div",2,0),F("click",function(){return d(r),h(n.onFocusInput())}),D(2,"div",3),B(3,Gt,3,3,"div",null,Kt),x(),D(5,"div",4)(6,"div",5)(7,"input",6,1),it("ngModelChange",function(a){return d(r),ot(n.command,a)||(n.command=a),h(a)}),F("input",function(){return d(r),h(n.onUpdateCursorPosition())})("click",function(){return d(r),h(n.onUpdateCursorPosition())})("keyup",function(){return d(r),h(n.onUpdateCursorPosition())})("keydown",function(a){return d(r),h(n.onKeyDown(a))})("keydown.enter",function(){return d(r),h(n.onExecCommand())}),x(),H(9,"div",7),x()()()}e&2&&(p(3),G(n.terminalEvents()),p(4),nt("ngModel",n.command),p(2),tt("left",n.cursorPos()*.6+"ch"))},dependencies:[Yt,yt,dt,ht,ft],styles:[".ps-terminal-app[_ngcontent-%COMP%]{font-family:Courier New,Courier,monospace}.ps-terminal-app[_ngcontent-%COMP%]   pre[_ngcontent-%COMP%]{margin:0;padding:.25rem 0;font-family:inherit}.ps-terminal-app[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]{font-family:inherit}"],changeDetection:0})}return o})();export{Wn as TerminalAppComponent};
